...
(env PATH="$QPATH" WVM_SHM_FILE=/wvm_flat_node0 stdbuf -oL -eL "$ROOT/slave_daemon/wavevm_node_slave" 19105 1 1024 0 19101) >"$ART_DIR/slave0.log" 2>&1 &
S0=$!
...
S1=$!
(env PATH="$QPATH" WVM_INSTANCE_ID=0 WVM_SHM_FILE=/wvm_flat_node0 stdbuf -oL -eL "$ROOT/master_core/wavevm_node_master" 1024 19100 "$CFG" 0 19101 19105 1) >"$ART_DIR/master0.log" 2>&1 &
M0=$!
